...
const STR = {
  en: {
    ...
    stats: 'Your stars', starsLabel: 'Stars', statsPlayed: 'Levels played', statsFound: 'Differences found', privacy: 'Privacy policy', privacyOptions: 'Ad privacy options', about: 'About', aboutText: 'A cosy spot-the-difference game by Nabu Tarot: real photos of candles, crystals, moons and skies, and nothing in here is scary.', photoCredits: 'Photo credits', photoCreditsSub: 'The pictures are photographs shared on Pexels by these photographers. Thank you.', reset: 'Reset progress', resetSure: 'Delete all progress? This cannot be undone.', version: 'Version',
  ...
  vi: {
    ...
    stats: 'Sao của bạn', starsLabel: 'Sao', statsPlayed: 'Số màn đã chơi', statsFound: 'Điểm khác đã tìm', privacy: 'Chính sách riêng tư', privacyOptions: 'Tuỳ chọn quảng cáo', about: 'Giới thiệu', aboutText: 'Game tìm điểm khác nhau nhẹ nhàng của Nabu Tarot: ảnh thật về nến, pha lê, trăng và bầu trời, và không có gì đáng sợ.', photoCredits: 'Ảnh của', photoCreditsSub: 'Các bức ảnh do những nhiếp ảnh gia này chia sẻ trên Pexels. Xin cảm ơn.', reset: 'Xoá tiến trình', resetSure: 'Xoá toàn bộ tiến trình? Không thể hoàn tác.', version: 'Phiên bản',
